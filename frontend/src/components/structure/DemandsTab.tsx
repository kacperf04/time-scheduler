...
export default function DemandsTab() {
    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <div className="w-1/3 pl-4 bg-white rounded-lg py-2">
                <span className={`border-l-5 pl-2 ${
                    ...
                    Demand deadline for {currentMonthString} is {currentMonthString} {currentMonthLastDay}. 
            ...
            <div className="bg-white w-full p-5 rounded-md">
                ...
                {
                    !isLoading && processedDemand && (
                        <DemandCalendar demand={processedDemand}/>
                    )
                }
